...
export function SessionLobby() {
  ...
  const saveIdentity=(sessionCode:string,memberId:string,token:string)=>localStorage.setItem(`macroboard-session-${sessionCode}`,JSON.stringify({memberId,memberToken:token,displayName:display,role}));
